...
public class RButton extends JButton
{
    ...
    private boolean hover;
	    ...
	    public RButton(String name, int style)
	    {
	    	super.setText(name);
			if (style == pink)
			{
    ...
    {
    	ImageIcon icon = new ImageIcon("F:\\Mygit3DMax\\threed-client\\icon\\background\\07.png");  
		JFrame frm = new JFrame();
		RButton but = new RButton("圆角JButton", 0);
		but.setIcon(icon);
		
		JButton bb=new JButton("cccc",icon);
		bb.setBounds(30, 70, 70, 30);
		frm.setLayout(null);
