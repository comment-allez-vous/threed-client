...
public class MyPhotoConstantsUI {
	...
	public final static String USER_PIC_PATH = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "14.png"; //可改成propertis配置形式
	public final static String CATALOG_BENDI = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "21.png";
	public final static String CATALOG_BENDI_CHOOSE = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "22.png";
	public final static String CATALOG_YUN = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "23.png";
	public final static String CATALOG_YUN_CHOOSE = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "23.png";
	...
	public final static String LOGIN_BACKGROUND = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "001.jpg";
	public final static String SEARCH_PIC_PATH = CURRENT_DIR + File.separator + "icon" + File.separator + "background" + File.separator + "24.png"; //可改成propertis配置形式
	//下载图片所放的路径
