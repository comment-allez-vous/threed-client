...
//            modellabel.setIcon(image);
			modellabel = new JLabel();
			String str = "<html><img style=\"border-radius:10px;width:" + photoBean.getWidth() + "px;height:" + photoBean.getImageheight() + "px;\" src='" + photoBean.getImagePath() + "'></img></html>";
			System.out.println(str);
			modellabel.setBorder(new ThreeDimensionalBorder(Color.white, 200, 0));
