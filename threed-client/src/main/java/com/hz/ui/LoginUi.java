...
public class LoginUi extends JFrame {
    ...
    public void userInit() {
        ...
        this.setSize(922, 530);//设置框架大小为长300,宽200
        ...
        this.btnClose.setBounds(this.getWidth() - 33, 0, 33, 33);//设置大小和位置
        ...
        this.btnMin.setBounds(this.getWidth() - 33 - 34, 0, 33, 33);//设置大小和位置
        ...
        this.lbluserLogIn.setBounds(this.getWidth() / 2 - 87, this.getHeight() / 2 - 200, 174, 90);//设置标签x坐标120,y坐标15,长60,宽20
        ...
        this.lbluserName.setBounds(this.lbluserLogIn.getX() - 50, this.lbluserLogIn.getY() + 100, 100, 30);
        this.lbluserName.setBorder(null);
        this.lbluserName.setOpaque(false);
        //用户名输入框
        this.txtName.setBorder(null);
        this.txtName.setOpaque(false);
        this.txtName.setBounds(this.lbluserName.getX() + this.lbluserName.getWidth(), this.lbluserName.getY(), 180, 30);
        ...
        this.lbluserPWD.setBounds(this.lbluserName.getX(), this.lbluserName.getY() + this.lbluserName.getHeight() + 20, 100, 30);
        this.lbluserPWD.setBorder(null);
        this.lbluserPWD.setOpaque(false);
        //密码输入框
        this.pwdPwd.setBorder(null);
        this.pwdPwd.setOpaque(false);
        this.pwdPwd.setBounds(this.lbluserPWD.getX() + this.lbluserPWD.getWidth(), this.lbluserPWD.getY(), 180, 30);
        ...
        this.btnSub.setBounds(this.lbluserPWD.getX()+10, this.lbluserPWD.getY()+60, 250, 40);
        ...
        this.lblBeh.setBounds(10, this.getHeight() - 30, 100, 30);
        this.lblBeh.setBorder(null);
        this.lblBeh.setOpaque(false);

        //注册按钮
        this.btnReset.setBounds(this.getWidth() - 60, this.getHeight() - 30, 60, 30);
